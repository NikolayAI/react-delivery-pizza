        ...
        <div className='cart'>
          <div className='cart__top'>
            ...
            <div className='cart__clear'>
              ...
              >
                ...
                />
                <path
                  d='M6.66663 5.00001V3.33334C6.66663 2.89131 6.84222 2.46739
                  7.15478 2.15483C7.46734 1.84227 7.89127 1.66667 8.33329
                  1.66667H11.6666C12.1087 1.66667 12.5326 1.84227 12.8451
                  2.15483C13.1577 2.46739 13.3333 2.89131 13.3333
                  3.33334V5.00001M15.8333 5.00001V16.6667C15.8333 17.1087
                  15.6577 17.5326 15.3451 17.8452C15.0326 18.1577 14.6087
                  18.3333 14.1666 18.3333H5.83329C5.39127 18.3333 4.96734
                  18.1577 4.65478 17.8452C4.34222 17.5326 4.16663 17.1087
          ...
          <div className='content__items'>
            {cartItemsRaw.map((item) => (
              <CartItemRow
                key={item.id}
                {...item}
                totalItemPrice={items[item.id].totalItemPrice}
                totalItemCount={items[item.id].items.length}
          ...
          <div className='cart__bottom'>
            ...
            <div className='cart__bottom-buttons'>
              ...
              <button className='button pay-btn' onClick={handleClickCheckout}>
